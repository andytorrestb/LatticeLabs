...
results_dir = 'results-GZS-' + isoDashTimeString
...
for t=1:T
    ...
    % title("Velocity Plot (t = " + t + ")");
    % axis equal tight;
    % saveas(gcf,results_dir + "/u_quiver-" + t + ".png" );
    % 
    % clf;
    % figure;
    % contourf(Rho, 30);
    % title("Density Plot (t = " + t + ")");
    % axis equal tight;
    % saveas(gcf,results_dir + "/rho_contour-" + t + ".png" );
end
