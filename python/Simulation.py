...
class Simulation():
    ...
    def update(self):
        ...
        # Print macroscopic quantities
        print("rho:", self.computational_domain.rho)
        print("u_x:", self.computational_domain.u_x)
        print("u_y:", self.computational_domain.u_y)
        print("u:", self.computational_domain.u)
